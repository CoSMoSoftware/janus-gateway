			...
			onremotestream: function(stream) {
				...
				if($('#remotevideo'+remoteFeed.rfindex).length === 0) {
					...
					$('#videoremote'+remoteFeed.rfindex).append(
						'<span class="label label-primary hide" id="curres'+remoteFeed.rfindex+'" style="position: absolute; top: -18px; right: 250px;"></span>' +
						'<span class="label label-info hide" id="curbitrate'+remoteFeed.rfindex+'" style="position: absolute; top: -18px; right: 0px;"></span>');
